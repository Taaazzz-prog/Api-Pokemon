...
const STARTERS = [
    {
        ...
        rarity: client_1.PokemonRarity.COMMON,
        generation: 1,
    ...
    },
    {
        ...
        rarity: client_1.PokemonRarity.UNCOMMON,
        generation: 1,
    ...
    for (const starter of STARTERS) {
        const pokemon = await prisma.pokemon.upsert({
            ...
            create: {
                ...
                spriteGmax: null,
                maleRate: new client_1.Prisma.Decimal(50),
                femaleRate: new client_1.Prisma.Decimal(50),
            },
            update: {
                nameFr: starter.nameFr,
                nameEn: starter.nameEn,
    ...
    const items = [
        {
            ...
            rarity: client_1.PokemonRarity.COMMON,
            priceCurrency: client_1.Currency.POKE_CREDITS,
            priceAmount: 500,
        ...
        },
        {
            ...
            rarity: client_1.PokemonRarity.COMMON,
            priceCurrency: client_1.Currency.POKE_GEMS,
            priceAmount: 3,
            metadata: { reward: { currency: client_1.Currency.POKE_CREDITS, amount: 750 } },
        },
    ];
...
async function seedUser() {
    ...
    await prisma.transaction.create({
        data: {
            userId: user.id,
            currency: client_1.Currency.POKE_CREDITS,
